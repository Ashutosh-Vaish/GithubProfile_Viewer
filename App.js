    ...
    fetch(`https://api.github.com/users/${user_name}/repos`)
        ...
        .then(function(repo_data) {
            ...
            if (repo_data.length <= 0) {
                repo_details.innerHTML = `<div class = "item_">
                ...
                if (repo_data.message === "Not Found") {
                    repo_details.innerHTML = ` <div class="item_">
                <div class="repo_name">AshutoshVaish</div>
                <div class="repo_details_">
                    ...
                    let repo_Data = repo_data.map(item => {
                        ...
                        <div class="repo_details_">
                            ...
                            <div class="info_size">
                                <p><i class="fa fa-code-fork"></i>${item.size}</p>
                            </div>
                        </div>
                    </div>`);
                    })
                    repo_details.innerHTML = repo_Data.slice(0, 7).join("");
                }
            }
        })
